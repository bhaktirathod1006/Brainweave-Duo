    ...
    <div className="bg-white">
      ...
      >
        ...
        <h1 className="absolute inset-x-0 top-20 z-20 flex items-center justify-between px-6 text-center leading-[0.95] text-white sm:top-24 sm:px-10 md:top-24 md:px-14 lg:px-20">
          <span className="font-teko shrink-0 text-[3.5rem] sm:text-[6.5rem] md:text-[9rem] lg:text-[11.5rem]">मिट्टी</span>
          <span className="shrink-0 text-[2.5rem] opacity-70 sm:text-[4.5rem] md:text-[6rem] lg:text-[7.5rem]">-</span>
          <span className="font-instrument shrink-0 text-[2.5rem] sm:text-[5rem] md:text-[7rem] lg:text-[9rem]">MITTI</span>
        </h1>
        ...
        <div className="pointer-events-none absolute inset-0 z-30" style={{ clipPath: "inset(40% 0 0 0)" }}>
          <video
            src={FRONT_VIDEO}
            autoPlay
            loop
